...
Un jeu de proximité à jouer entre amis en vrai : piégez quelqu'un avant de vous faire piéger. Assisté par GPS, basé sur des photos. Deux modes de jeu, le plus de piégeages gagne (par défaut) ou dernier survivant.

Téléchargez l'application sur [Google Play](https://play.google.com/store/apps/details?id=me.roboroads.framed).
