...
return targetLocation(_that);case FrameToJudge() when frameToJudge != null:
return frameToJudge(_that);case FrameCancelled() when frameCancelled != null:
return frameCancelled(_that);case FrameVerdict() when frameVerdict != null:
...
return targetLocation(_that);case FrameToJudge():
return frameToJudge(_that);case FrameCancelled():
return frameCancelled(_that);case FrameVerdict():
...
return targetLocation(_that.lat,_that.lng);case FrameToJudge() when frameToJudge != null:
return frameToJudge(_that.frameId,_that.photoPath,_that.targetNameCiphertext,_that.targetSelfiePath);case FrameCancelled() when frameCancelled != null:
return frameCancelled(_that.frameId);case FrameVerdict() when frameVerdict != null:
...
return targetLocation(_that.lat,_that.lng);case FrameToJudge():
return frameToJudge(_that.frameId,_that.photoPath,_that.targetNameCiphertext,_that.targetSelfiePath);case FrameCancelled():
return frameCancelled(_that.frameId);case FrameVerdict():
...
class FrameToJudge implements GameEvent {
  const FrameToJudge({required this.frameId, required this.photoPath, required this.targetNameCiphertext, required this.targetSelfiePath});
  

 final  String frameId;
 final  String photoPath;
 final  String targetNameCiphertext;
 final  String targetSelfiePath;

/// Create a copy of GameEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FrameToJudgeCopyWith<FrameToJudge> get copyWith => _$FrameToJudgeCopyWithImpl<FrameToJudge>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FrameToJudge&&(identical(other.frameId, frameId) || other.frameId == frameId)&&(identical(other.photoPath, photoPath) || other.photoPath == photoPath)&&(identical(other.targetNameCiphertext, targetNameCiphertext) || other.targetNameCiphertext == targetNameCiphertext)&&(identical(other.targetSelfiePath, targetSelfiePath) || other.targetSelfiePath == targetSelfiePath));
}


@override
int get hashCode => Object.hash(runtimeType,frameId,photoPath,targetNameCiphertext,targetSelfiePath);

@override
String toString() {
  return 'GameEvent.frameToJudge(frameId: $frameId, photoPath: $photoPath, targetNameCiphertext: $targetNameCiphertext, targetSelfiePath: $targetSelfiePath)';
}
...
/// @nodoc
abstract mixin class $FrameToJudgeCopyWith<$Res> implements $GameEventCopyWith<$Res> {
  factory $FrameToJudgeCopyWith(FrameToJudge value, $Res Function(FrameToJudge) _then) = _$FrameToJudgeCopyWithImpl;
@useResult
$Res call({
 String frameId, String photoPath, String targetNameCiphertext, String targetSelfiePath
});
...
/// @nodoc
class _$FrameToJudgeCopyWithImpl<$Res>
    implements $FrameToJudgeCopyWith<$Res> {
  _$FrameToJudgeCopyWithImpl(this._self, this._then);

  final FrameToJudge _self;
  final $Res Function(FrameToJudge) _then;

/// Create a copy of GameEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? frameId = null,Object? photoPath = null,Object? targetNameCiphertext = null,Object? targetSelfiePath = null,}) {
  return _then(FrameToJudge(
...
class FrameCancelled implements GameEvent {
  const FrameCancelled({required this.frameId});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FrameCancelledCopyWith<FrameCancelled> get copyWith => _$FrameCancelledCopyWithImpl<FrameCancelled>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FrameCancelled&&(identical(other.frameId, frameId) || other.frameId == frameId));
}
...
@override
String toString() {
  return 'GameEvent.frameCancelled(frameId: $frameId)';
}
...
/// @nodoc
abstract mixin class $FrameCancelledCopyWith<$Res> implements $GameEventCopyWith<$Res> {
  factory $FrameCancelledCopyWith(FrameCancelled value, $Res Function(FrameCancelled) _then) = _$FrameCancelledCopyWithImpl;
@useResult
$Res call({
 String frameId
});
...
/// @nodoc
class _$FrameCancelledCopyWithImpl<$Res>
    implements $FrameCancelledCopyWith<$Res> {
  _$FrameCancelledCopyWithImpl(this._self, this._then);

  final FrameCancelled _self;
  final $Res Function(FrameCancelled) _then;

/// Create a copy of GameEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? frameId = null,}) {
  return _then(FrameCancelled(
frameId: null == frameId ? _self.frameId : frameId // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
